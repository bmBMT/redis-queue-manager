...
import { RedisAddConnectionDto, RedisAddConnectionDtoType } from "@server/resources/redis/dto/add-new-conneciton.dto";
    ...
    <Fragment>
      ...
      >
        <Form style={{ maxWidth: 600 }} autoComplete="off" layout="vertical" {...formField}>
          ...
          <Form.Item help={testConnectionError?.message} validateStatus={testConnectionError ? "error" : ""}>
            <Button
              className="w-full"
